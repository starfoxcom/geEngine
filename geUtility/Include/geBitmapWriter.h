...
namespace geEngineSDK
{
	...
	*/
	...
	public:
		...
		* @param[in]	input			The input set of bytes in RGB or RGBA format. Starting byte represents the top left pixel
		*								of the image and following pixels need to be set going from left to right, row after row.
		* @param[out]	output			Preallocated buffer where the BMP bytes will be stored. Use getBMPSize() to retrieve the
		*								size needed for this buffer.
		* @param[in]	width		  	The width of the image in pixels.
		* @param[in]	height		  	The height of the image in pixels.
		* @param[in]	bytesPerPixel 	Number of bytes per pixel. 3 for RGB and 4 for RGBA images. Other values not supported.
		*/
		/************************************************************************************************************************/
