...
void Init(sf::Window& window, sf::RenderTarget& target, bool loadDefaultFont)
{
    ...
    // init rendering
    sf::Vector2f displaySize = static_cast<sf::Vector2f>(target.getSize());
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ImGui::Image((void*)texture.getNativeHandle(), ImVec2(size.x, size.y), ImVec2(0, 0), ImVec2(1, 1), ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a), ImVec4(borderColor.r, borderColor.g, borderColor.b, borderColor.a));
}
    ...
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ...
    ImGui::Image((void*)texture.getNativeHandle(), ImVec2(size.x, size.y), uv0, uv1, ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a), ImVec4(borderColor.r, borderColor.g, borderColor.b, borderColor.a));
}
