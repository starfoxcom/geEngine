 ...
 * @date    2014/02/02
 * @brief   Minimal includes for Windows.h
 *
 * Instead of including Windows.h, this file sets all the defines needed for
...
#ifdef _WINDOWS_
# pragma message ( " " )
# pragma message ( "You have included Windows.h before geMinWindows.h" )
